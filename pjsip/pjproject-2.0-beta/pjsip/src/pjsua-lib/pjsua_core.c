/* $Id: pjsua_core.c 3891 2011-12-01 09:06:14Z nanang $ */
/* 
...
//tid Why is this called only if the user set a custom callback??
//tid    if (pjsua_var.ua_cfg.cb.on_transport_state) {
					      ...
					      pjsua_transport_info *info)
{
   ...
   PJ_LOG(1,(THIS_FILE, "Tranport Type: %d", pjsua_var.tpdata[id].type));

    if (pjsua_var.tpdata[id].type == PJSIP_TRANSPORT_UDP) {

PJ_LOG(1,(THIS_FILE, "Tranport Type UDP"));
...
PJ_LOG(1,(THIS_FILE, "Tranport Type TCP"));
...
PJ_LOG(1,(THIS_FILE, "Tranport Type UNKNOWN!"));
