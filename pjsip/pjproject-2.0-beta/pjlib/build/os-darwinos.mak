...
ifeq ($(YARN_HAS_VIDEO), 1)
export PJLIB_OBJS += 	addr_resolv_sock.o guid_simple.o \
			log_writer_stdout.o os_core_unix.o \  #changed from Albert tests, there was os_core_darwin.os instead of os_core_unix.os, original pjsip is as with*_unix.o
