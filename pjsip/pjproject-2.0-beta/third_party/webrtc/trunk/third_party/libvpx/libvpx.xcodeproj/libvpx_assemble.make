...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/dequantize_mmx.o \
    ...
    $(BUILT_PRODUCTS_DIR)/yasm
	@mkdir -p "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx"
	@echo note: "Compile assemly source/libvpx/vp8/decoder/x86/dequantize_mmx.asm."
	"$(BUILT_PRODUCTS_DIR)/yasm" -I source/config/mac/ia32 -I source/libvpx -fmacho32 -m x86 -o "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/dequantize_mmx.o" "source/libvpx/vp8/decoder/x86/dequantize_mmx.asm"
...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/sad_mmx.o \
    ...
    $(BUILT_PRODUCTS_DIR)/yasm
	@mkdir -p "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx"
	@echo note: "Compile assemly source/libvpx/vp8/encoder/x86/sad_mmx.asm."
	"$(BUILT_PRODUCTS_DIR)/yasm" -I source/config/mac/ia32 -I source/libvpx -fmacho32 -m x86 -o "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/sad_mmx.o" "source/libvpx/vp8/encoder/x86/sad_mmx.asm"
...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/sad_sse2.o \
    ...
    $(BUILT_PRODUCTS_DIR)/yasm
	@mkdir -p "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx"
	@echo note: "Compile assemly source/libvpx/vp8/encoder/x86/sad_sse2.asm."
	"$(BUILT_PRODUCTS_DIR)/yasm" -I source/config/mac/ia32 -I source/libvpx -fmacho32 -m x86 -o "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/sad_sse2.o" "source/libvpx/vp8/encoder/x86/sad_sse2.asm"
...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/sad_sse3.o \
    ...
    $(BUILT_PRODUCTS_DIR)/yasm
	@mkdir -p "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx"
	@echo note: "Compile assemly source/libvpx/vp8/encoder/x86/sad_sse3.asm."
	"$(BUILT_PRODUCTS_DIR)/yasm" -I source/config/mac/ia32 -I source/libvpx -fmacho32 -m x86 -o "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/sad_sse3.o" "source/libvpx/vp8/encoder/x86/sad_sse3.asm"
...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/sad_sse4.o \
    ...
    $(BUILT_PRODUCTS_DIR)/yasm
	@mkdir -p "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx"
	@echo note: "Compile assemly source/libvpx/vp8/encoder/x86/sad_sse4.asm."
	"$(BUILT_PRODUCTS_DIR)/yasm" -I source/config/mac/ia32 -I source/libvpx -fmacho32 -m x86 -o "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/sad_sse4.o" "source/libvpx/vp8/encoder/x86/sad_sse4.asm"
...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/sad_ssse3.o \
    ...
    $(BUILT_PRODUCTS_DIR)/yasm
	@mkdir -p "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx"
	@echo note: "Compile assemly source/libvpx/vp8/encoder/x86/sad_ssse3.asm."
	"$(BUILT_PRODUCTS_DIR)/yasm" -I source/config/mac/ia32 -I source/libvpx -fmacho32 -m x86 -o "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/sad_ssse3.o" "source/libvpx/vp8/encoder/x86/sad_ssse3.asm"
...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/variance_impl_mmx.o \
    ...
    $(BUILT_PRODUCTS_DIR)/yasm
	@mkdir -p "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx"
	@echo note: "Compile assemly source/libvpx/vp8/encoder/x86/variance_impl_mmx.asm."
	"$(BUILT_PRODUCTS_DIR)/yasm" -I source/config/mac/ia32 -I source/libvpx -fmacho32 -m x86 -o "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/variance_impl_mmx.o" "source/libvpx/vp8/encoder/x86/variance_impl_mmx.asm"
...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/variance_impl_sse2.o \
    ...
    $(BUILT_PRODUCTS_DIR)/yasm
	@mkdir -p "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx"
	@echo note: "Compile assemly source/libvpx/vp8/encoder/x86/variance_impl_sse2.asm."
	"$(BUILT_PRODUCTS_DIR)/yasm" -I source/config/mac/ia32 -I source/libvpx -fmacho32 -m x86 -o "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/variance_impl_sse2.o" "source/libvpx/vp8/encoder/x86/variance_impl_sse2.asm"
...
$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/variance_impl_ssse3.o \
    ...
    $(BUILT_PRODUCTS_DIR)/yasm
	@mkdir -p "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx"
	@echo note: "Compile assemly source/libvpx/vp8/encoder/x86/variance_impl_ssse3.asm."
	"$(BUILT_PRODUCTS_DIR)/yasm" -I source/config/mac/ia32 -I source/libvpx -fmacho32 -m x86 -o "$(SHARED_INTERMEDIATE_DIR)/third_party/libvpx/variance_impl_ssse3.o" "source/libvpx/vp8/encoder/x86/variance_impl_ssse3.asm"
