...
# since gyp_chromium is automatically forcing its inclusion.
{
  ...
  'variables': {
    ...
    # Chrome normally builds with the Mac OS X 5.0 SDK and sets the
    # deployment target to 5.0.  Other projects, such as O3D, may override
    # these defaults.
    'mac_sdk%': '5.0',
    'mac_deployment_target%': '5.0',
          ...
          ['asan==1', {
            'xcode_settings': {
              ...
              'OTHER_LDFLAGS': [
                ...
                # targeting 5.0.0, we need to explicitly mark these
            ...
            'postbuilds': [
              {
                ...
                # is set for ASLR when running on Mac OS X 5.0 ("Leopard").
                'variables': {
  ...
  'xcode_settings': {
    ...
    'SDKROOT': 'iphoneos<(mac_sdk)',  # -isysroot
