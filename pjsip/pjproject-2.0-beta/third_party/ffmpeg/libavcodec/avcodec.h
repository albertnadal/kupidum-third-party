...
#define CODEC_FLAG_PART   0x0080  ///< Use data partitioning.  //SEEMS to be broken in the code... it blows up calls.
#endif
/**
...
#define CODEC_FLAG_OBMC           0x00000001 ///< OBMC: overlapped block motion compensation 
#endif
#define CODEC_FLAG_LOOP_FILTER    0x00000800 ///< loop filter
#define CODEC_FLAG_INTERLACED_ME  0x20000000 ///< interlaced motion estimation
#define CODEC_FLAG_CLOSED_GOP     0x80000000
#define CODEC_FLAG2_FAST          0x00000001 ///< Allow non spec compliant speedup tricks. Cannot be used in this implementation with H.263/H.263+/MPEG-4 with OBMC
