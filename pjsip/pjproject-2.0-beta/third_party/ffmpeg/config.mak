...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-doc --disable-ffplay --disable-ffprobe --disable-ffserver --disable-ffmpeg --disable-w32threads --disable-os2threads --enable-cross-compile --disable-everything --enable-encoder=h261 --enable-encoder=h263 --enable-encoder=h263p --enable-decoder=vp8 --enable-decoder=h261 --enable-decoder=h263 --enable-decoder=h263i --enable-hwaccel=h263_vaapi --enable-muxer=h261 --enable-muxer=h263 --enable-muxer=webm --enable-demuxer=h261 --enable-demuxer=h263 --enable-demuxer=iv8 --enable-parser=h261 --enable-parser=h263 --enable-parser=vp8 --enable-filter=scale --enable-libvpx --arch=arm --target-os=darwin --cc=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc --as='gas-preprocessor.pl /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc' --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.0.sdk --extra-cflags='-O3 -g -w -arch armv7 -mfpu=neon -I/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.0.sdk/usr/include ' --extra-ldflags='-arch armv7 -mfpu=neon -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.0.sdk' --enable-pic --disable-asm
prefix=/usr/local
...
LN_S=ln -sf
STRIP=strip -x
CPPFLAGS= --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.0.sdk -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS= -O3 -g -w -arch armv7 -mfpu=neon -I/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.0.sdk/usr/include  -std=c99 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -mllvm -stack-alignment=16
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -O3 -g -w -arch armv7 -mfpu=neon -I/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.0.sdk/usr/include  -fPIC -g
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -arch armv7 -mfpu=neon -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.0.sdk --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.0.sdk -Wl,-dynamic,-search_paths_first
...
ACODEC_TESTS=adpcm_adx aref g722 g723_1 pcm_alaw pcm_f32be pcm_f32le pcm_f64be pcm_f64le pcm_mulaw pcm_s16be pcm_s16le pcm_s24be pcm_s24daud pcm_s24le pcm_s32be pcm_s32le pcm_s8 pcm_u8 
VCODEC_TESTS=amv cljr dnxhd_720p_10bit ffvhuff h261 h263 h263p jpeg2000 msvideo1 prores prores_kostya qtrle qtrlegray r210 v210 v308 vref y41p yuv4 
LAVF_FATE_TESTS=
LAVF_TESTS=caf dpx pam rso sox sunrast voc_s16 wtv xwd 
