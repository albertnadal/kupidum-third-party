/* $Id: vid_stream.c 3905 2011-12-09 05:15:39Z ming $ */
/* 
...
#if YARN_HAS_VIDEO
    // ang Setup the frame as an empty frame by default
    stream->dec_frame.is_empty = PJ_TRUE;
    frame->is_empty = PJ_TRUE;
#endif
...
#if YARN_HAS_VIDEO
		frame->is_empty = PJ_FALSE;
	    stream->dec_frame.is_empty = PJ_FALSE;
#endif
