/* $Id: vid_port.c 3905 2011-12-09 05:15:39Z ming $ */
/*
...
#if YARN_HAS_VIDEO
	dst_frame->is_empty = src_frame->is_empty;
#endif
				       ...
				       pjmedia_frame *frame)
{
    ...
    if (vp->role==ROLE_ACTIVE) {
        ...
        vp->frm_buf->size = vp->frm_buf_size;
#if YARN_HAS_VIDEO
	// ang By default the video frame is empty (not loaded from network)
        vp->frm_buf->is_empty = PJ_TRUE;
#endif
